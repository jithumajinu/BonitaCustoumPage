...
(function() {
  ...
  (function(resources) {
    ...
    'masterlistAPI': 'extension/mastergetList',
    'doneTaskAPI': 'bpm/archivedFlowNode',


  });
  module.factory('masterTaskAPI', function($http) {

      var masterTaskAPI = {};


      masterTaskAPI.getMasterDataList = function(urlString) {
        return $http({
          url:'../../../API/'+urlString,
          method: 'GET'
        });
      ...
      masterTaskAPI.getProcessChangePolicyProcessList = function() {
        return $http({
          url:'../../../API/extension/processChangePolicyProcessGet',
          method: 'GET'
        });
      };

      masterTaskAPI.listDoneTasks = function(caseId) {
        return $http({
          url:'../../../API/bpm/archivedFlowNode?c=1000&d=executedBy&d=executedBySubstitute&f=caseId='+caseId+'&f=isTerminal=true&o=archivedDate+DESC&p=0',
          method: 'GET'
        });
      };
...
masterTaskAPI.migrateDataEntry = function(requestData,user) {
  var data = {};
  data.dataRow = requestData;
  data.userId  = user.user_id;
  return $http({
    url:'../../../API/extension/masteUpdateRestAPI',
    method:'PUT',
    data: requestData
  });
};
...
*/
      masterTaskAPI.getMigrationEntryList = function() {
        return $http({
          url:'../../../API/extension/processMigrationEntryGet',
          method:'GET'
        });
      };
